...
<body>
    ...
    <div id="layout-wrapper">
                            ...
                            <button type="button" class="btn shadow-none" id="page-header-user-dropdown"
                                ...
                                <span class="d-flex align-items-center">
                                    <img class="rounded-circle header-profile-user"
                                        src="/ad/assets/images/users/avatar-9.jpg" alt="Header Avatar">
        ...
        <div class="app-menu navbar-menu">
            ...
            <div class="navbar-brand-box">
                <!-- Dark Logo-->
                <a href="index.html" class="logo logo-dark text-light">
                    <span class="logo-sm ">
                        {{-- <img src="/ad/assets/images/logo-sm.png" alt="" height="22"> --}}
                        Admin
                    </span>
            ...
            <div id="scrollbar">
                <div class="container-fluid">
                    ...
                    <ul class="navbar-nav" id="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-link {{$nav_item['codePage'] == $attributes['title'] ? 'active' : ''}}" href="#{{$nav_item['codePage']}}" data-bs-toggle="collapse"
                                role="button" aria-expanded="false" aria-controls="{{$nav_item['codePage']}}">
                            ...
                            <div class="collapse menu-dropdown {{$isShow ? 'show' : ''}}" id="{{$nav_item['codePage']}}">
                                ...
                                <div class="page-title-right">
                                    <ol class="breadcrumb m-0">
                                        <li class="breadcrumb-item"><a
                                                href="javascript: void(0);">{{$attributes['title']}}</a></li>
    ...
    <div class="customizer-setting d-none d-md-block">
        <div class="btn-info btn-rounded shadow-lg btn btn-icon btn-lg p-2" data-bs-toggle="offcanvas"
            data-bs-target="#theme-setting" aria-controls="theme-setting">
    ...
    <div class="offcanvas offcanvas-end border-0" tabindex="-1" id="theme-setting">
        ...
        <div class="offcanvas-footer border-top p-3 text-center">
            <div class="row">
                ...
                <div class="col-6">
                    <a href="https://1.envato.market/velzon-admin" target="_blank" class="btn btn-primary w-100">Lưu</a>
                </div>
            </div>
        </div>
    </div>
